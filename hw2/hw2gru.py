...
def main():
    ...
    dataset = data.TabularDataset('train_copy.json', 'json',
    ...
    for epoch in range(student.epochs):
        ...
        for i, batch in enumerate(trainLoader):
            ...
            #KOVID #################
            kovid = loss.item()
            loss_kovid.append(round(kovid, 3))
    ...
    # print(loss_kovid)
    print('Max Loss:', max(loss_kovid))
    print('Min Loss:', min(loss_kovid))
    print('Fin Loss:', (loss_kovid)[-1])
    ...
    print(net)
    print(f'Batchsize : {student.batchSize}\nEpochs : {student.epochs}\nLR : {student.lrate}'
    )
