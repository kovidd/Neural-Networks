...
#--- Kovid ---#
# parser.set_defaults(net='polar')
# parser.set_defaults(net='raw')
# parser.set_defaults(init=0.001)
# parser.set_defaults(init=0.01)
# parser.set_defaults(init=0.1)
# parser.set_defaults(init=0.2)
# parser.set_defaults(init=0.1)
# parser.set_defaults(hid='10')
# parser.set_defaults(lr=0.02)


# parser.set_defaults(net='polar', lr=0.03)
parser.set_defaults(net='raw', lr=0.02)
args = parser.parse_args()
#--- Kovid ---#
...
print(f'Hidden layers : {args.hid}')
